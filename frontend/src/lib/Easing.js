...
/**
 * Power easing - raises t to the specified power
 *
 * @param {number} n - The power (default: 4)
 * @returns {function} Easing function
 */
function poly(n = 4) {
 ...
 *
 * @param {number} overshoot - Amount of overshoot (default: 1.70158)
 * @returns {function} Easing function
 */
...
/**
 * Easing modifiers - transform any easing function
 */

/**
 * Run easing function forwards (ease-in)
 */
...
/**
 * Run easing function backwards (ease-out)
 */
function out(easing) {
...
/**
 * Run easing symmetrically (ease-in-out)
 */
